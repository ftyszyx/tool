...
excelpath="D:\work\策划\导表\dialogue.xls"
luapath="D:\work\MCardClient\Env\lua\config\dialogue.lua"
uexcelpath=unicode(excelpath , "utf8")
uluapath=unicode(luapath , "utf8") 
print "covert table :",uexcelpath," to lua table:",uluapath
convertToLua(uexcelpath,uluapath)
os.system("pause")
